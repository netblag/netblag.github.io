export const copy = {
  en: {
    ...
    education: {
      ...
      focusText:
        'Statistics · Python · Data Analysis · Machine Learning',
    },
    ...
    tools: {
      ...
      subtitle:
        'Small, practical utilities for everyday work.',
      ...
      items: [
        ...
        [
          'markdown',
          'Markdown Preview',
          'Write Markdown and preview the result.',
        ],

        [
          'text',
          'Text Tools',
          'Count and transform text.',
        ],

        [
          'timestamp',
          'Timestamp Converter',
          'Convert Unix timestamps locally.',
        ],
        ...
        [
          'uuid',
          'UUID Generator',
          'Generate random UUIDs in your browser.',
        ],
  ...
  fa: {
    ...
    education: {
      ...
      focusText:
        'آمار · پایتون · تحلیل داده · یادگیری ماشین',
    },
    ...
    contact: {
      ...
      text:
        'برای ایده‌های خوب، گفت‌وگوهای فنی و پروژه‌های جالب همیشه جا هست.',
    },
    ...
    tools: {
      ...
      subtitle:
        'ابزارهای کوچک و کاربردی برای کارهای روزمره.',
      ...
      items: [
        [
          'json',
          'قالب‌بندی JSON',
          'مرتب‌سازی، اعتبارسنجی و بررسی ساختار JSON.',
        ],
        ...
        [
          'base64',
          'کدگذاری Base64',
          'کدگذاری و بازگردانی متن با Base64.',
        ],

        [
          'uuid',
          'ساخت شناسه یکتا',
          'ساخت شناسه تصادفی و یکتا در مرورگر.',
        ],
      ] as [string, string, string][],
    },
  },
